    ...
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            if (dgvDetainedLicenses.Rows.Count > 0)
            {
                ...
                dgvDetainedLicenses.Columns[0].Width = 85;

                dgvDetainedLicenses.Columns[1].HeaderText = "L.ID";
                dgvDetainedLicenses.Columns[1].Width = 85;
                ...
                dgvDetainedLicenses.Columns[7].Width = 255;
        ...
        private void btnDetainLicense_Click(object sender, EventArgs e)
        {
            ...
            // Refresh the detained licenses list after detaining a license
        ...
        private void PesonDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            _PersonID = clsLicense.FindByLicenseID(_LicenseID).DriverInfo.PersonID;

            frmPersonInformation frm = new frmPersonInformation(_PersonID);
            frm.ShowDialog();
